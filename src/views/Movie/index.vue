         ...
         <div id="content">
             <div class="movie_menu">
				<div class="hot_swtich">
					...
					<router-link tag="div" to="/movie/future" class="hot_item">即将上映</router-link>
				</div>
...
.movie_menu .hot_item{ font-size: 15px; color:#666; width:150px; text-align:center; margin:0 12px; font-weight:700;}
